        ...
        <div class="col-12 col-md-7">
            ...
            <div class="text-center pt-3">
                ...
                <a href="{{ route('admin.restaurant.edit', $restaurant) }}"
                    class="mt-3 me-4 btn ms-btn shadow bg-white rounded"><i class="fa-solid fa-pen"></i>
                    Modifica il tuo ristorante</a>

                {{-- bottone delete --}}

                <button type="button" class="btn ms-btn mt-3 shadow bg-white rounded" data-bs-toggle="modal"
